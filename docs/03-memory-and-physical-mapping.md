...
stressapptest는 먼저 virtual memory 영역을 확보하고, worker가 접근할 때 실제 physical page를 연결합니다. 이 장에서는 메모리 크기를 정하는 방법과 virtual address, physical address, LPDDR 좌표의 차이를 설명합니다.
...
## Virtual 주소가 연속이어도 physical 주소는 다를 수 있음
