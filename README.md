...
> **GitBook:** [stressapptest 한글 설명서](https://stressapptest-mobile-arm64.gitbook.io/stressapptest-mobile-arm64-docs/)

GitBook에서는 메뉴, 페이지 목차, 검색, 코드 강조 표시를 사용할 수 있습니다. `master` branch와 연결되어 있어 `docs/`의 변경 내용이 배포 문서에 반영됩니다.

왼쪽 메뉴를 하늘색 배경으로, 본문을 흰색 배경으로 설정하는 값은 [`GITBOOK_THEME.md`](GITBOOK_THEME.md)에 정리했습니다.
